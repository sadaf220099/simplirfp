...
function Use() {
  return (
    ...
    <img
        src={bottom3}
        alt="Decoration"
        className="absolute -top-55 right-0 z-0"
      />
      <div className="bg-white p-4 sm:p-6 md:p-10 w-full min-h-screen mb-10 overflow-hidden">
        ...
        <div className="flex justify-center items-center mt-8 sm:mt-10">
          <div className="relative inline-block w-full max-w-[1040px]">
            <video
              className="w-full h-auto object-cover z-1 rounded-3xl"
              src={Banner}
              autoPlay
              loop
              muted
        ...
        <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] bg-[#DFDFDF] z-[1] mt-10 mb-10 py-10 sm:py-14 md:py-20 px-4 sm:px-8 md:px-20">
